    ...
    <div id="wrapper">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 col-md-push-3">
                                    ...
                                    <form name="login-form" id="lawyer-login" class="clearfix" method="post">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input id="form_username_email" name="email" class="form-control" type="email" placeholder="Enter User Email">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-12">
     ...
     <?php
        if (!empty($js)) {
            foreach ($js as $value) {
                ?>
                <script src="<?= base_url() ?>fassets/js/<?php echo $value; ?>" type="text/javascript"></script>
            <?php
            }
        }
        ?>
